...
var vueUtil = {
	...
	post: function (API,requestData,successCallback,errorCallback,hideError) {
		...
		*/
		Vue.http.post(API, requestData).then(function (fetchData) {
				var data = fetchData.body;
				if (data.code === 1) {
	...
	/* GET 请求 */
	get: function (API,requestData,successCallback,errorCallback) {
		/*
			API: API URL
			requestData: 请求的参数
			successCallback: 请求成功的cb
